...
> 当前版本：`v0.2.0` 测试版。最低支持 Android 8.0（API 26），目标 Android 15。

## 下载与体验

请在仓库右侧 **Releases** 中下载最新的 `message-atlas-v0.2.0-debug.apk`。这是使用 Android Debug 证书签名的体验版本，适合安装测试；正式商店发布版本将使用独立发行签名。
